...
@SpringBootTest
class MovieHelperTests {
	@Test
	void testToDTONullMovie() {
		Movie o = null;
		MovieDTO result = MovieHelper.toDTO(o);
	...
	void testToDTOSetOfMovies() {
		...
		assertNotNull(result, "The result should not be null");
		assertEquals(2, result.size(), "The result should contain 2 movies");
	...
	void testToEntityMovieDTOWithNoActors() {
		MovieDTO movieDTO = new MovieDTO(1L, "Test Movie", 2020, 5, Collections.emptySet());
	...
	void testToEntitySetOfMovieDTOs() {
		MovieDTO movieDTO1 = new MovieDTO(1L, "Movie 1", 2020, 5, Collections.emptySet());
		MovieDTO movieDTO2 = new MovieDTO(2L, "Movie 2", 2021, 3, Collections.emptySet());
